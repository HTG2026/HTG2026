...
Internal recommendations to implement into site operations. Not for user display.
...
## Content & Data
- [ ] Connect real-time Eventbrite API for live Orlando events (partial: cron exists)
- [ ] Add user reviews and ratings (or aggregate from Google/TripAdvisor)
- [ ] Integrate OpenTable/Resy for restaurant reservations (links exist)
- [ ] Add "Price from" and booking links for experiences (partial)
